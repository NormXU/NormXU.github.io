...
> エマノン’s post introduces how to create a Slider LoRa. For those who don't read Japanese, I've summarized the key points from the original post below.
