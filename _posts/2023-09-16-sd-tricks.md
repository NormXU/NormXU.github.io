...
Besides, Here I draw the SDXL-UNet structure for easier reference

<img src="https://raw.githubusercontent.com/NormXU/NormXU.github.io/main/_data/resources/blog/1/sdxl_unet.png" width="512">
Figure 2. SDXL UNET structure
...
Figure 3. Original SDM UNET structure; image credited to [BK-SDM paper](https://openreview.net/pdf?id=bOVydU0XKC)

we can clearly see from Fig.2 and Fig.3 that the lowest latent dimension is set to 16 rather than 8. According to the paper, they remove the dimension 8 for efficiency reasons. Moreover, they also omit the transformer block at the highest feature level, further saving the computation cost.
...
Figure 5. reference-only pipeline; ①: the first diffusion forward pass, ②: the second diffusion forward pass
...
Figure 8; Merge LoRA A, which is trained to overfit one reference image, and LoRA B, which is trained to overfit another image, into the based model using different weights; credit to [@Emanon\_14](https://twitter.com/Emanon_14/status/1700746112112714236?ref_src=twsrc%5Etfw%7Ctwcamp%5Etweetembed%7Ctwterm%5E1700746112112714236%7Ctwgr%5E70c38d02b4fbc72c6baec078647a0744b0f4cb3c%7Ctwcon%5Es1_&ref_url=https%3A%2F%2Fnote.com%2Femanon_14%2Fn%2Fneb46bac832f2)
...
Figure 9; credit to  [@Emanon\_14](https://twitter.com/Emanon_14/status/1700746112112714236?ref_src=twsrc%5Etfw%7Ctwcamp%5Etweetembed%7Ctwterm%5E1700746112112714236%7Ctwgr%5E70c38d02b4fbc72c6baec078647a0744b0f4cb3c%7Ctwcon%5Es1_&ref_url=https%3A%2F%2Fnote.com%2Femanon_14%2Fn%2Fneb46bac832f2); Except for the head size of the two characters, the other components remain identical at the pixel level.
...
<h4 class="no_toc"> 1. the generation setting of Figure 4 (reference-only showcase)</h4>
...
<h4 class="no_toc"> 2. the generation setting of Figure 6 (reference mode comparsion)</h4>
