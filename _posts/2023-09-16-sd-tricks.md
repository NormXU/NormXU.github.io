...
Figure2. reference-only showcase;  **Left:** reference image credit by [@001_31_](<https://twitter.com/001_31_/media>); **Right:** generated image with reference-only mode; please check the appendix for more setting details;
...
Figure3. reference-only pipeline
...
Another implementation processes both the unconditional and conditional latent features in the same way.
...
#### Figure2,  reference-only showcase generation setting
